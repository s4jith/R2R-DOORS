    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link
            href="/products"
            className="px-4 py-2 rounded-lg bg-primary text-white text-sm font-semibold hover:bg-primary/90 transition-colors shadow-sm"
          >
            Explore Products
          </Link>
        </div>
        ...
        <div className="md:hidden bg-white border-t border-border px-6 py-4 flex flex-col gap-1">
          ...
          <div className="mt-2 pt-2 border-t border-border">
            <Link
              href="/products"
              onClick={() => setMenuOpen(false)}
              className="block px-4 py-2.5 rounded-lg bg-primary text-white text-sm font-semibold text-center transition-colors"
            >
              Explore Products
            </Link>
          </div>
